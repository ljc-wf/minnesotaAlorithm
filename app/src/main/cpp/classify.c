...
#define NEW_TYPE_NOISE_THRESHOLD	180	// Above this noise level, do not create
												// new beat types.
...
int Classify(int *newBeat,int rr, int noiseLevel, int *fidAdj,
	int init)
	{
