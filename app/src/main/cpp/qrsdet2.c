...
// rahul commented #define MIN_PEAK_AMP	7 // Prevents detections of peaks smaller than 150 uV.
#define MIN_PEAK_AMP	1 // Prevents detections of peaks smaller than 150 uV.
